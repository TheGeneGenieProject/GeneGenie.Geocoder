...
dotnet sonarscanner begin /k:"GeneGenie.Geocoder" /d:sonar.organization="thegenegenieproject" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.login=%SonarQubeApiKey% /d:sonar.cs.opencover.reportsPaths="%CD%\opencover.xml"
dotnet build
